...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (user_book_loans_today_count($conn, $uid, $today) >= DAILY_BOOK_LOAN_CAP) {
        $error = "You've reached today's limit of " . DAILY_BOOK_LOAN_CAP . " new book checkout(s). Please come back tomorrow, or return a book first.";
    } else {
...
<p class="form-hint">You can check out up to <?= DAILY_BOOK_LOAN_CAP ?> new book(s) per day.</p>
