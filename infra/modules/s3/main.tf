# assignment-s3-uploads: holds room/equipment/book photo uploads. Bucket ACLs
# stay blocked; only unauthenticated GetObject under uploads/* is allowed via
# bucket policy so images render in the browser, without allowing public
# listing or writes.
