...
variable "artifact_bucket" {
  description = "S3 bucket that deploy.yml uploads application release artifacts to (same bucket as room/equipment/book photo uploads, under a different key prefix)."
  type        = string
}
